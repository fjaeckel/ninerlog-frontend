...
export const METRIC_OPTIONS: { value: CurrencyMetric; label: string; time: boolean }[] = [
  ...
  { value: 'picus_time', label: 'PICUS time', time: true },
  { value: 'spic_time', label: 'SPIC time', time: true },
  { value: 'examiner_time', label: 'Examiner time', time: true },
  { value: 'relief_time', label: 'Cruise relief time', time: true },
