...
export const previewTemplates: ImportTemplate[] = [
  {
    ...
    confidence: "exact",
    description:
      "ForeFlight Logbook export. Carries a separate Aircraft Table, so your fleet — make, model and class — is created alongside the flights.",
    exportSteps: [
  ...
  },
  {
    ...
    confidence: "exact",
    description:
      "A CSV written by NinerLog's own Export screen. Re-importing one round-trips cleanly, including instructor, approach and endorsement columns.",
    exportSteps: [
  ...
  },
  {
    ...
    confidence: "exact",
    description:
      "LogTen Pro flight export — the Dynamic Export column set and the field-key (flight_…) dialect. Times are H:MM or bare four-digit clock times.",
    exportSteps: [
  ...
  },
  {
    ...
    confidence: "exact",
    description:
      "MyFlightbook CSV export. It records the route as a single field rather than separate airports, so departure and arrival are taken from the first and last waypoint — a flight logged with an empty Route cannot be imported.",
    exportSteps: [
  ...
  },
  {
    ...
    confidence: "exact",
    description:
      "capzlog.aero flights report. Dates each flight by its off-block timestamp rather than a date column, and carries the Swiss mountain/glacier and rotary external-load columns alongside the standard EASA breakdown.",
    exportSteps: [
  ...
  },
  {
    ...
    confidence: "exact",
    description:
      "FLYLOG.io CSV export. Carries block and airborne times, the full EASA duration breakdown, and named crew per role.",
    exportSteps: [
  ...
  },
  {
    ...
    confidence: "exact",
    description:
      "Wader Pilot Logbook CSV export. Carries block, takeoff and landing times, the full EASA duration breakdown and up to four named crew. Rows Wader marks as previous experience or simulator sessions are imported as ordinary flights and are worth reviewing afterwards.",
    exportSteps: [
  ...
  },
  {
    ...
    confidence: "exact",
    description:
      "Vereinsflieger club flight list, standard export. Records take-off and landing times but no off-block/on-block pair, so the total is airborne time rather than block time — prefer the extended export if your club offers it. Carries no aircraft type and no night or instrument breakdown.",
    exportSteps: [
  ...
  },
  {
    ...
    confidence: "exact",
    description:
      "Vereinsflieger club flight list, extended export. Adds off-block and on-block times and the block time in minutes, so flights are totalled on block time as EASA FCL.050 expects. This is the export to use if your club offers it.",
    exportSteps: [
      "Sign in at vereinsflieger.de.",
      "Open Flugbetrieb → Flüge and filter to your own flights.",
  ...
  },
  {
    ...
    confidence: "exact",
    description:
      "SkyDemon logbook export. It dates each flight by its departure and arrival timestamps rather than a date column, and records no total time — the total is derived from those two. Durations are whole minutes, and registrations are exported without their hyphen. Approach and hold detail is not exported at all.",
    exportSteps: [
  ...
  },
  {
    ...
    confidence: "exact",
    description:
      "The standard European logbook column layout. Use this for any EU logbook app or spreadsheet whose columns follow AMC1 FCL.050, including NinerLog's own EASA CSV export.",
    exportSteps: [
  ...
  },
  {
    ...
    confidence: "exact",
    description:
      "The classic US paper-logbook column layout used by ASA and Jeppesen books and by NinerLog's own FAA CSV export.",
    exportSteps: [
  ...
  },
  {
    ...
    description:
      "Any other CSV, tab- or semicolon-separated file. Columns are matched by name where possible and the rest is mapped by hand — nothing is imported until you have seen the preview.",
    exportSteps: [
