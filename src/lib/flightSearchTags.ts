...
export const SEARCH_TAGS: SearchTag[] = [
  ...
  { name: 'picusTime', aliases: ['picus'], type: 'duration', example: 'picus>0' },
  { name: 'spicTime', aliases: ['spic'], type: 'duration', example: 'spic>0' },
  { name: 'examinerTime', aliases: ['examiner'], type: 'duration', example: 'examiner>0' },
  { name: 'reliefTime', aliases: ['relief'], type: 'duration', example: 'relief>0' },
