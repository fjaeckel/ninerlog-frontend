...
export function exportAnalyticsToCSV(a: FlightAnalytics) {
  ...
  block(
    ...
    [
      ...
      ['PICUS', fmt(t.picusMinutes)],
      ['SPIC', fmt(t.spicMinutes)],
      ['SIC', fmt(t.sicMinutes)],
      ['Cruise relief', fmt(t.reliefMinutes)],
      ['Dual received', fmt(t.dualMinutes)],
      ['Dual given', fmt(t.dualGivenMinutes)],
      ['Examiner', fmt(t.examinerMinutes)],
...
${table(
  ...
  (
    [
      ['PIC', t.picMinutes],
      ['PICUS', t.picusMinutes],
      ['SPIC', t.spicMinutes],
      ['SIC', t.sicMinutes],
      ['Cruise relief', t.reliefMinutes],
      ['Dual received', t.dualMinutes],
      ['Dual given', t.dualGivenMinutes],
      ['Examiner', t.examinerMinutes],
      ['Solo', t.soloMinutes],
